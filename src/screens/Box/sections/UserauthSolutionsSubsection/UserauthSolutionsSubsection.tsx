  ...
  return (
    <div className="w-full flex flex-col bg-white shadow-[0px_3px_6px_#120f281f] relative">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-[122px]">
        <Card className="w-full max-w-[342px] bg-white rounded-[10px] shadow-[0px_0px_1px_#171a1f12,0px_0px_2px_#171a1f1f] border-0">
          <CardContent className="pt-[27px] pb-6 px-6">
            ...
            <div className="space-y-2 mb-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="username"
                  placeholder="请输入用户名"
                  className="pl-11 h-auto py-2.5 [font-family:'Inter',Helvetica] font-normal text-[#565d6d] text-sm tracking-[0] leading-[22px] bg-white rounded-md border border-solid border-[#dee1e6]"
                />
              </div>
            </div>
            ...
            <Button className="w-full h-12 mt-2 bg-[#636ae8] hover:bg-[#636ae8]/90 rounded-md [font-family:'Inter',Helvetica] font-medium text-white text-base text-center tracking-[0] leading-[26px]">
              登录
            </Button>

            <Button
              variant="outline"
              className="w-full h-12 mt-4 bg-white hover:bg-gray-50 rounded-md border border-solid border-[#dee1e6] [font-family:'Inter',Helvetica] font-medium text-[#171a1f] text-base text-center tracking-[0] leading-[26px]"
            >
              注册新账户
            </Button>
          </CardContent>
        ...
        <div className="w-full flex bg-white shadow-[0px_8px_17px_#171a1f26,0px_0px_2px_#171a1f1f]">
          {navigationItems.map((item, index) => (
            ...
            >
              ...
              <div
                className={`mt-1 [font-family:'Inter',Helvetica] text-[10px] tracking-[0] leading-4 whitespace-nowrap ${item.isActive ? "font-bold text-[#636ae8]" : "font-normal text-[#565d6d]"}`}
              >
                {item.label}
              </div>
            </button>
