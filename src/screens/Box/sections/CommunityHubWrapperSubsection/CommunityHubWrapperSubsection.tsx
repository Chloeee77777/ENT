            ...
            {communityGroups.map((group, index) => (
              ...
              >
                <CardContent className="flex flex-col items-center gap-[19px] p-4">
                  ...
                  <div className="[font-family:'Inter',Helvetica] font-medium text-[#171a1f] text-lg text-center tracking-[0] leading-7 whitespace-nowrap">
                    {group.label}
                  </div>
                </CardContent>
              </Card>
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4 mb-5">
                        ...
                        <div className="[font-family:'Inter',Helvetica] font-medium text-[#171a1f] text-lg tracking-[0] leading-7 whitespace-nowrap">
                          {user.name}
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-1 mb-[13px]">
                        ...
                        <div className="flex gap-2">
                          {user.goodAt.map((skill, skillIndex) => (
                            <Badge
                              key={skillIndex}
                              className="bg-[#e8618c] text-white rounded-[15px] h-[30px] px-2 [font-family:'Inter',Helvetica] font-medium text-sm tracking-[0] leading-[22px] hover:bg-[#e8618c]"
                            >
                              {skill}
                            </Badge>
                          ))}
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <div className="flex gap-2">
                          {user.wantToLearn.map((skill, skillIndex) => (
                            <Badge
                              key={skillIndex}
                              className="bg-[#fafafb] text-[#171a1f] rounded-[15px] h-[30px] px-2 [font-family:'Inter',Helvetica] font-medium text-sm tracking-[0] leading-[22px] hover:bg-[#fafafb]"
                            >
                              {skill}
                            </Badge>
                          ))}
      ...
      <nav className="flex flex-col gap-[0.5px] shadow-[0px_8px_17px_#171a1f26,0px_0px_2px_#171a1f1f]">
        ...
        <div className="flex bg-white shadow-[0px_8px_17px_#171a1f26,0px_0px_2px_#171a1f1f]">
          {navigationItems.map((item, index) => (
            ...
            >
              <img className="w-6 h-6 mb-1" alt={item.label} src={item.icon} />
              <div
